...
<body>
  ...
  <div class="container">
    <h3 class="text-center" style="color: #212529;">Registration update Track Details</h3>

    <table id="RegistrationupdateTable" class="table">
      <thead>
        <tr>
         <th class="hide-column">Register-up ID</th>
         <th class="hide-column">Register ID</th>
          <th>Package</th>
          <th>Trainer</th>
           <th>Amount</th>
           <th>AmountPaid</th>
